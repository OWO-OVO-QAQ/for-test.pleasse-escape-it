...
char ssid[] = "TP-LINK_5B21";    // your network SSID (name)
char pass[] = "7711241124";    // your network password (use for WPA, or use as key for WEP)
...
const char broker[]    = "iot-06z00ip6ri8tm2j.mqtt.iothub.aliyuncs.com";
int        port        = 1883;
const char willTopic[] = "arduino/will";
const char inTopic[]   = "/sys/k298jO3X4GT/esp8266/thing/event/property/post";
const char outTopic[]  = "/sys/k298jO3X4GT/esp8266/thing/service/property/set";
...
void setup() {
  ...
  mqttClient.setId("k298jO3X4GT.esp8266|securemode=2,signmethod=hmacsha256,timestamp=1737112171430|");
mqttClient.setUsernamePassword("esp8266&k298jO3X4GT","4a41bd5e6afb2438e799f067ed78d957431190cf54a9814aebd308a7e6f25a5f");
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    payload = "{\"params\":{\"temp\":1.22,\"humi\":66},\"version\":\"1.0.0\"}";
